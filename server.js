 ...
 *   npm start
 *
 * En Render, ver package.json (script "start") y el PORT se toma
 * automáticamente de la variable de entorno que Render inyecta.
 *
...
app.get("/", (req, res) => {
  res.send("ANTENA proxy activo. Usa /proxy?url=<URL_CODIFICADA>");
});
...
app.listen(PORT, HOST, () => {
  console.log("ANTENA proxy escuchando en http://" + HOST + ":" + PORT);
});
